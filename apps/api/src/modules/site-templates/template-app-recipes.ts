...
const RECIPES: Record<string, AppInstallRecipe> = {
  ...
  drupal: recipe(
    [
      ...
      {
        id: "drupal-files",
        title: "Prepare Drupal public files (incl. translations)",
        cmd: `${SRV} && mkdir -p web/sites/default/files/translations web/sites/default/files/tmp private && chmod -R 775 web/sites/default/files private 2>/dev/null || chmod -R 777 web/sites/default/files private`,
      },
    ],
    "web/index.php",
    [
